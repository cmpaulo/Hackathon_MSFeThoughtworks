...
# curl --request GET --location 'https://api.twitter.com/2/tweets/search/recent?tweet.fields=context_annotations&max_results=100&
# query=camping(nature%20OR%20%22outdoor%20actvities%22)' \
